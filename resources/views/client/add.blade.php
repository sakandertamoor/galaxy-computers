            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" enctype="multipart/form-data" id="client_form"
                        ...
                        <div class="form-group">
                            <label>Address</label>
                            <textarea type="text"  rows="5" class="form-control @error('address') is-invalid @enderror" placeholder="Address"  name="address">{{ old('address') }}</textarea>
                          </div>
                        <div>
